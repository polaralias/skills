...
- <img src="./skills/engineering/repo-task-lifecycle/assets/icon.svg" alt="repo-task-lifecycle icon" width="22"> [repo-task-lifecycle](./skills/engineering/repo-task-lifecycle) (RTL): maintain OKF task bundles with workstreams, effort and estimates, RKE promotion, and first-class GitHub, GitLab, Linear, and ClickUp profiles, create/import/sync workflows, safe exports, and generated indexes.
