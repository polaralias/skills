...
- <img src="./skills/engineering/repo-task-lifecycle/assets/icon.svg" alt="repo-task-lifecycle icon" width="22"> [repo-task-lifecycle](./skills/engineering/repo-task-lifecycle) (RTL): maintain OKF task bundles with workstreams, effort and estimates, RKE promotion, project-default GitHub, GitLab, Linear, and ClickUp profiles, create/import/sync workflows, setup evidence, safe exports, and generated indexes.
