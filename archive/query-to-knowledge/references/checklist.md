...
- separate repo-answerable questions from user-judgement questions
...
- ask one question at a time only when the next branch depends on the answer
- keep each question short
- prefer contradiction-driven batches when possible
- use concrete scenarios to force precision
- summarise resolved, open, and changed understanding after each batch
- capture resolved terms in the glossary file such as `GLOSSARY.md` or `CONTEXT.md`
- capture durable decisions in `docs/decisions/`
- capture support-boundary, contract, or plan outcomes in the right canonical artefact
