...
description: Turn natural-language meeting requests or pasted scheduling batches into
  calendar-aware slot proposals and ready-to-send emails. Use when a user wants availability
  checked, similar existing meetings spotted, up to three candidate times proposed,
  or a scheduling wave handled across multiple requests. Prefer live calendar connectors
