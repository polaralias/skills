...
- when a manifest exists, prefer the artifact paths and workflow hints it names
...
- verify manifest and supplement claims such as branch, commit, as-of point, or artifact paths rather than accepting them blindly
