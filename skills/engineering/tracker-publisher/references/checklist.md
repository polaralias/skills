# tracker-publisher checklist

- confirm the work packages are already stable enough to publish
- read shared Polaralias tracker defaults when they exist
- preserve the existing hierarchy from epic to feature to task
